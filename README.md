...
1. Revenue by Product Category (horizontal bar)
2. Revenue by Age Group (doughnut)
3. Zone-wise Revenue split (doughnut)
4. Top Occupations by Revenue (bar)
5. Revenue by gender (Line chart)
